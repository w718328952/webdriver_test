...
def equ_config():
	...
	time.sleep(1)
	driver.find_element_by_id(id_='input_id3').send_keys('5.0')
	...
	for i in range(int(times)):
		...
		time.sleep(1)
		name = driver.find_element_by_id(id_='hidden_download').get_attribute('download')
		file_name = name.replace('/', '_')
		print('第%i次测试：'%(i+1), file_name)
		time.sleep(10)
		i += 1
